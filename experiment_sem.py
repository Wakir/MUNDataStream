...
def run_experiment(chunk_size, dataset_name, semantic_case_1, semantic_case_2, window_size, ulr, learning_rate ,random_seed, metrics, alghoritm):
    stream = DataStream(
...
def mlflow_run(chunk_size, dataset_name, semantic_case_1, semantic_case_2, window_size, learning_rate, unlearning_rate, random_seed, metrics, alghorithm):
...
semantic_cases_1 = ["fashion_v1", "fashion_v2"] #["animals", "swim", "fly"] for CIFAR-10
semantic_cases_2 = ["fashion_v1", "fashion_v2"] #["animals", "swim", "fly"] for CIFAR-10
...
mlflow.set_experiment("Semantic_ Drift")
...
param_grid = [
    ...
    for chunk_size, semantic_case_1, semantic_case_2,
        window_size, learning_rate, unlearning_rate, random_seed, alghorithm
...
results = Parallel(n_jobs=-1, verbose=10)(
    ...
    for chunk_size, semantic_case_1, semantic_case_2, window_size, learning_rate, unlearning_rate, random_seed, algorithm in param_grid
)
